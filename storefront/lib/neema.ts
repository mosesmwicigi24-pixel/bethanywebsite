...
/* Researched buyer language for church supplies (Kenya + diaspora): canonical
   term → the variants people actually type — synonyms, Swahili/Kiswahili terms,
   and common misspellings. Combined with per-product `aliases` from the hub,
   this is what lets "divai", "bishop hat", "thurble" or "mkate wa ushirika"
   land on the right product. */
const SYNONYMS: Record<string, string[]> = {
  "chalice": ["challice", "chalise", "communion cup", "goblet", "kikombe", "cup"],
  "paten": ["patten", "bread plate", "communion plate", "host plate", "sahani", "plate"],
  "host": ["hosts", "communion host", "altar bread", "priest host", "hostia", "wafer", "wafers", "communion bread"],
  "wafer": ["wafers", "communion wafer", "communion bread", "mkate wa ushirika"],
  "wine": ["divai", "devai", "mvinyo", "altar wine", "communion wine", "grape juice"],
  "cassock": ["cassok", "cassoc", "casock", "soutane", "kanzu", "priest robe", "robe", "clergy robe"],
  "chasuble": ["chasable", "chasible", "chausable", "mass vestment", "vestment", "vestments"],
  "cope": ["cope cape", "bishop cape", "clergy cape", "cope vestment"],
  "stole": ["stoal", "stola", "clergy stole", "priest scarf", "preaching scarf", "tippet", "scarf"],
  "alb": ["albs", "alb robe", "white alb", "priest alb", "surplice", "gown"],
  "surplice": ["surplus", "surplis", "surpluce", "choir surplice"],
  "collar": ["clergy collar", "roman collar", "tab collar", "collar tab", "clerical collar", "dog collar"],
  "cincture": ["sincture", "cinture", "girdle", "fascia", "cassock belt", "cincture band"],
  "tallit": ["prayer shawl", "talit", "tallis", "talith", "jewish shawl", "tallit shawl", "prayer wear"],
  "mitre": ["miter", "bishop mitre", "bishop hat", "mitre hat"],
  "zucchetto": ["zuchetto", "zucheto", "skull cap", "skullcap", "bishop cap"],
  "crosier": ["crozier", "bishop staff", "pastoral staff", "shepherd staff", "crosier staff"],
  "thurible": ["thurble", "thurable", "censer", "incense burner", "chetezo"],
  "bell": ["altar bell", "sanctus bell", "mass bell", "church bell", "kengele"],
  "tray": ["communion tray", "cup tray", "bread tray", "serving tray", "sinia"],
  "cup": ["communion cups", "prefilled cups", "pre-filled cups", "disposable cups", "vikombe", "kikombe"],
  "cross": ["msalaba", "crucifix", "altar cross", "pectoral cross", "processional cross"],
  "ring": ["bishop ring", "episcopal ring", "clergy ring", "pete"],
  "bible": ["biblia", "bibilia", "holy bible", "pulpit bible", "lectern bible", "bibles", "scripture"],
  "devotional": ["devotionals", "devotion book", "daily devotional", "prayer book"],
  "gown": ["clergy gown", "pulpit gown", "preaching gown", "pastors gown", "ordination gown", "choir gown"],
  "robe": ["clergy robe", "pastor robe", "minister robe", "choir robe", "baptismal robe", "joho", "kanzu"],
  "incense": ["ubani", "uvumba", "frankincense", "church incense", "incense sticks", "loban"],
  "anointing": ["anointing oil", "annointing oil", "mafuta ya upako", "holy oil", "chrism", "olive oil"],
  "sprinkler": ["aspergillum", "holy water sprinkler", "aspersorium", "water sprinkler"],
  "vestment": ["vestments", "clergy vestments", "liturgical vestments", "mavazi"],
  "candle": ["altar candles", "baptismal candle", "paschal candle", "mishumaa", "church candles"],
  "communion": ["holy communion", "ushirika mtakatifu", "ekaristi", "eucharist", "lords supper", "communion elements", "communion ware"],
  "hymn book": ["hymnal", "hymn books", "tenzi za rohoni", "nyimbo za injili", "golden bells"],
  "offering": ["offering bags", "offering baskets", "collection bags", "offertory bags", "sadaka"],
};
