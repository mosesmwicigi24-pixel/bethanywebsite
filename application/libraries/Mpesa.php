...
/*    public function getSettings(){
        ...
        foreach($result as $row){
            $this-> $CONSUMER_KEY = $row->mpesa_sonsumer_key;
            $this-> $CONSUMER_SECRET = $row->mpesa_secret_key;
            $this-> $ENVIRONMENT = $row->mpesa_ENVIRONMENT;
            $this-> $SHORTCODE = $row->mpesa_paybill_number;
        }
    }*/
    /**
     ...
     * @return mixed|string
     */
    public static function reversal($CommandID, $Initiator, $SecurityCredential, $TransactionID, $Amount, $ReceiverParty, $RecieverIdentifierType, $ResultURL, $QueueTimeOutURL, $Remarks, $Occasion, $ENVIRONMENT, $CONSUMER_KEY, $CONSUMER_SECRET){
     ...
     * @return string
     */
    public static function b2c($InitiatorName, $SecurityCredential, $CommandID, $Amount, $PartyA, $PartyB, $Remarks, $QueueTimeOutURL, $ResultURL, $Occasion, $ENVIRONMENT, $CONSUMER_KEY, $CONSUMER_SECRET){
     ...
     * @param $ResponseType | Only two values are allowed: Completed or Cancelled. Completed means MPesa will automatically complete your transaction, whereas Cancelled means MPesa will automatically cancel the transaction, in the event MPesa is unable to reach your Validation URL.
     ...
     */
    public static function c2b_registerurl($ShortCode, $ResponseType, $ConfirmationURL, $ValidationURL, $ENVIRONMENT, $CONSUMER_KEY, $CONSUMER_SECRET){
     ...
     * @return mixed|string
     */
    public  static  function  c2b($ShortCode, $CommandID, $Amount, $Msisdn, $BillRefNumber, $ENVIRONMENT, $CONSUMER_KEY, $CONSUMER_SECRET){
     ...
     * @return mixed|string
     */
    public static function accountBalance($CommandID, $Initiator, $SecurityCredential, $PartyA, $IdentifierType, $Remarks, $QueueTimeOutURL, $ResultURL, $ENVIRONMENT, $CONSUMER_KEY, $CONSUMER_SECRET){
     ...
     * @return mixed|string
     */
    public function transactionStatus($Initiator, $SecurityCredential, $CommandID, $TransactionID, $PartyA, $IdentifierType, $ResultURL, $QueueTimeOutURL, $Remarks, $Occasion, $ENVIRONMENT, $CONSUMER_KEY, $CONSUMER_SECRET){
     ...
     * @return mixed|string
     */
    public function b2b($Initiator, $SecurityCredential, $Amount, $PartyA, $PartyB, $Remarks, $QueueTimeOutURL, $ResultURL, $AccountReference, $commandID, $SenderIdentifierType, $RecieverIdentifierType, $ENVIRONMENT, $CONSUMER_KEY, $CONSUMER_SECRET){
     ...
     * @return mixed|string
     */
    public function STKPushSimulation($BusinessShortCode, $LipaNaMpesaPasskey, $TransactionType, $Amount, $PartyA, $PartyB, $PhoneNumber, $CallBackURL, $AccountReference, $TransactionDesc, $Remark, $ENVIRONMENT, $CONSUMER_KEY, $CONSUMER_SECRET){
     ...
     * @return mixed|string
     */
    public static function STKPushQuery($checkoutRequestID, $businessShortCode, $password, $timestamp, $ENVIRONMENT, $CONSUMER_KEY, $CONSUMER_SECRET){
