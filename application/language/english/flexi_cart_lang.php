...
// Cart Item functions
$lang['items_added_successfully']					= "<i class='icon-checkmark-circle'></i> Item(s) added to cart successfully.";
$lang['no_items_added']								= "<i class='icon-cross-circle'></i> No items have been added to the cart.";
$lang['items_updated_successfully']					= "<i class='icon-checkmark-circle'></i> Cart items updated successfully.";
$lang['no_items_updated']							= "<i class='icon-cross-circle'></i> No cart items have been updated.";
$lang['items_deleted_successfully']					= "<i class='icon-checkmark-circle'></i> Item(s) removed from cart successfully.";
