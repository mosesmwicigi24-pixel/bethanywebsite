                        <?php if ($this->flexi_cart->cart_status()): ?>
                            <a class="header__extra" href="<?php echo base_url(); ?>cart"><i class="icon-cart"></i><span><i><?php echo $this->flexi_cart->total_items();?></i></span></a>
                                            ...
                                            <div class="ps-product__thumbnail">
                                                <a href="<?php echo base_url(); ?>product/<?php echo $row['product_reference_id']; ?>">
                                                    <?php if($row['product_image'] != '' && file_exists("./uploads/product_images/thumbs/" . $row['product_image'])): ?>
                                                        <img class="lazyload" src="<?php echo base_url();?>uploads/product_images/thumbs/<?php echo $row['product_image']; ?>" alt="">
                                                    <?php else: ?>
                                                        <img class="lazyload" src="<?php echo base_url();?>assets/fe/img/product-placeholder.jpg" alt="">
                                                    <?php endif; ?>
                                                </a>
                                            </div>
                        ...
                        <?php else: ?>
                            <a class="header__extra" href="<?php echo base_url(); ?>cart"><i class="icon-cart"></i><span><i>0</i></span></a>
                        <?php endif; ?>