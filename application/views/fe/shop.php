	                        ...
	                        <ul class="ps-list--categories">
	                        	<?php foreach($nested_product_categories as $row): ?>
	                        		<li class="current-menu-item <?php if(!empty($row->sub)){ echo 'menu-item-has-children'; } ?>">
	                        			<a href="<?php echo base_url();?>category/<?php echo $row->product_category_reference_id; ?>"><?php echo $row->product_category_name; ?></a><?php if(!empty($row->sub)){ echo '<span class="sub-toggle"><i class="fa fa-angle-down"></i></span>';} ?>
                        ...
                        <div class="ps-tabs">
                            <div class="ps-tab active" id="tab-1">
                                <div class="ps-shopping-product">
                                    <div id="div_products" style="min-height: 400px" class="row">
                                    	<?php foreach ($shop_products as $row2): ?>
	                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 mb-20">
