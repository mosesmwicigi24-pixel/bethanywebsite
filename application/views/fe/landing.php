...
<html lang="en">
    ...
    <head>
        ...
        <meta name="keywords" content="Bible, Holy Communion Bread and Wine in Nairobi, Devai, Prefilled Communion Cup, Holy Communion Items in Kenya, Anointing Oil, clergy Shirt, Bishop gowns, Ordination gowns, Mitre,holy communion elements for sale Bethany Gift Shop, Bethany House, Communion sets for church">
        <!--<meta name="keywords" content="<?php echo $meta['keywords']; ?>">-->
        <meta name="description" content="<?php echo $meta['description']; ?>" />
        <meta name="author" content="Bethany House">
        <?php if ($meta['sitemap'] != ''): ?>
        <meta name="sitemap_link" content="<?php echo $meta['sitemap']; ?>">
        <?php endif; ?>
        ...
        <meta name="twitter:creator" content="@Bethanyhouse">
        ...
        <title>Holy Communion Elements | Pastoral garments | Bethany House</title>

        <link href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700;1,800&display=swap" rel="stylesheet">
        <link rel="stylesheet" href="<?php echo base_url();?>assets/landing/vendors/fontawesome-pro-5/css/all.css" />
        <link rel="stylesheet" href="<?php echo base_url();?>assets/landing/vendors/bootstrap-select/css/bootstrap-select.min.css" />
        <link rel="stylesheet" href="<?php echo base_url();?>assets/landing/vendors/slick/slick.min.css" />
        <link rel="stylesheet" href="<?php echo base_url();?>assets/landing/vendors/magnific-popup/magnific-popup.min.css" />
        <link rel="stylesheet" href="<?php echo base_url();?>assets/landing/vendors/jquery-ui/jquery-ui.min.css" />
        <link rel="stylesheet" href="<?php echo base_url();?>assets/landing/vendors/animate.css" />
        <link rel="stylesheet" href="<?php echo base_url();?>assets/landing/vendors/mapbox-gl/mapbox-gl.min.css" />
        <link rel="stylesheet" href="<?php echo base_url();?>assets/landing/vendors/fonts/font-phosphor/css/phosphor.min.css" />
        <link rel="stylesheet" href="<?php echo base_url();?>assets/landing/vendors/fonts/tuesday-night/stylesheet.min.css" />

        <link rel="stylesheet" href="<?php echo base_url();?>assets/landing/css/themes.css" />

        <link rel="icon" href="<?php echo base_url();?>assets/landing/images/favicon.png" />
        
       
                  <!-- Google tag (gtag.js) -->
                    <script async src="https://www.googletagmanager.com/gtag/js?id=G-04CDCWMJET">
                    </script>
                    <script>
        ...
        <meta name="facebook-domain-verification" content="tzf1yvxa0r55d5ipxb2ndat7t4fmql" />
               ...
               <!-- Manychat -->
            <script src="//widget.manychat.com/1556733441275467.js" defer="defer"></script>
...
<!-- End of HubSpot Embed Code -->
    ...
    <body>
                ...
                <div class="container container-xxl">
                    <nav class="navbar navbar-expand-xl px-0 d-block">
                            ...
                            <div class="d-flex align-items-center flex-nowrap">
                                <div class="w-50">
                                    <div class="d-flex mt-3 mt-xl-0 align-items-center w-100">
                                        <a class="navbar-brand d-inline-block py-0" href="<?php echo base_url();?>">
                                ...
                                <div class="flex-shrink-0 mx-auto">
                                    <ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n5">
                                        <li class="nav-item py-2 py-xl-7 px-0 px-xl-3">
                                            <a class="nav-link p-0" href="<?php echo base_url();?>">Home</a>
                                        </li>
                                        <li class="nav-item py-2 py-xl-7 px-0 px-xl-3">
                                            <a class="nav-link p-0" href="<?php echo base_url();?>shop">Shop</a>
                                        </li>
                                        <li class="nav-item py-2 py-xl-7 px-0 px-xl-3">
                                            <a class="nav-link p-0" href="<?php echo base_url();?>new-arrivals">New Arrivals</a>
                                        </li>
                                        <li class="nav-item py-2 py-xl-7 px-0 px-xl-3">
                                            <a class="nav-link p-0" href="<?php echo base_url();?>featured">Featured</a>
                                        </li>
                                        <li class="nav-item py-2 py-xl-7 px-0 px-xl-3">
                                            <a class="nav-link p-0" href="<?php echo base_url();?>special-offers">Special Offers</a>
                                        </li>
                                        <li class="nav-item py-2 py-xl-7 px-0 px-xl-3">
                                            <a class="nav-link p-0" href="<?php echo base_url();?>blog">Blog</a>
                                        </li>
                                        <li aria-haspopup="true" aria-expanded="false" class="nav-item dropdown-item-home dropdown py-2 py-xl-7 px-0 px-xl-3">
                                            ...
                                            <ul class="dropdown-menu pt-3 pb-0 pb-xl-3 x-animated x-fadeInUp">
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="<?php echo base_url();?>about-us">
                                                        About Us
                                                    </a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="<?php echo base_url();?>terms-and-conditions">
                                                        Terms &amp; Conditions
                                                    </a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="<?php echo base_url();?>return-policy">
                                                        Return Policy
                                                    </a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="<?php echo base_url();?>privacy-policy">
                                                        Privacy Policy
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <li aria-haspopup="true" aria-expanded="false" class="nav-item dropdown-item-home dropdown py-2 py-xl-7 px-0 px-xl-3">
                                            ...
                                            <ul class="dropdown-menu pt-3 pb-0 pb-xl-3 x-animated x-fadeInUp">
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="<?php echo base_url();?>track">
                                                        Track Order
                                                    </a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="<?php echo base_url();?>how-to-shop">
                                                        How to Shop
                                                    </a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="<?php echo base_url();?>faqs">
                                                        Frequently Asked Questions
                                                    </a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="<?php echo base_url();?>contact-us">
                                                        Contact Us
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <div class="w-50">
                                    <div class="d-flex align-items-center justify-content-end">
                                        ...
                                        <ul class="navbar-nav flex-row justify-content-xl-end d-flex flex-wrap text-body py-0 navbar-right">
                                            <li class="nav-item">
                                                <a class="nav-link pr-3 py-0" href="<?php echo base_url();?>account">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link position-relative px-4 py-0" href="<?php echo base_url();?>account/favorites">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link position-relative px-4 menu-cart py-0 d-inline-flex align-items-center mr-n2" href="<?php echo base_url();?>cart">
                        ...
                        <div class="d-flex align-items-center d-xl-none">
                            ...
                            <div class="mx-auto">
                                <a class="navbar-brand d-inline-block mr-0 py-5" href="index.html">
                                    <img src="<?php echo base_url();?>assets/landing/images/logo.png" alt="Bethany House" />
                                </a>
                            </div>
                            <a href="<?php echo base_url();?>cart" class="nav-search d-flex align-items-center">
                                <!--  data-gtf-mfp="true" data-mfp-options='{"type":"inline","focus": "#keyword","mainClass": "mfp-search-form mfp-move-from-top mfp-align-top"}' -->
                                <svg class="icon icon-shopping-bag-open-light fs-28">
                                    <use xlink:href="#icon-shopping-bag-open-light"></use>
                                </svg>
                                <span class="d-none d-xl-inline-block ml-2 font-weight-500">Cart</span>
                            </a>
                        </div>
                    </nav>
                </div>
        ...
        <main id="content">
            <section>
                <div class="slick-slider mx-0 slider" data-slick-options='{"slidesToShow": 1,"infinite":true,"autoplay":true,"dots":false,"arrows":false,"fade":true,"cssEase":"ease-in-out","speed":600}'>
                    <div class="box px-0">
                        <div class="bg-img-cover-center py-12 pt-lg-18 pb-lg-17" style="background-image: url('<?php echo base_url();?>assets/landing/images/bg-landing-page-01.jpg');">
                            <div class="container container-xl py-7">
                                <div class="text-center" style="max-width: 454px;" data-animate="fadeInDown">
                                    <p class="text-primary fs-56 lh-113 mb-6 custom-font">Welcome to</p>
                                    <h1 class="mb-4 fs-56 lh-128">Bethany House</h1>
                                    <p class="fs-18 lh-166 mb-7" style="max-width: 454px;">We are the #1 Supplier of Holy Communion Elements, Clergy Apparels and Christian Gifts. We aim to ensure that every Christian is served with the Lord's table and can have a place to buy gifts to bless one another with.</p>
                                </div>
                                <div class="text-center" style="max-width: 454px;" data-animate="fadeInUp">
                                    <a href="<?php echo base_url();?>shop" class="btn btn-secondary rounded bg-hover-primary border-0">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container container-xl">
                    <div class="row mt-8 mb-6">
                        <div class="col-12 text-center" data-animate="fadeInUp">
                            <h2 class="mb-3">Holy Communion Elements</h2>
                            <p class="fs-18 mx-auto lh-166" style="max-width: 800px;">We have a wide array of elements including communion trays, communion cups, bread trays, altar wines/devai, wafers/hosts and refillers.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4 mb-8 mb-lg-0" data-animate="fadeInLeft">
                            <div class="card border-0 hover-shine hover-zoom-in banner banner-04">
                                <div class="card-img bg-img-cover-center" style="background-image: url('<?php echo base_url();?>assets/landing/images/1.jpg');"></div>
                                <div class="card-img-overlay d-inline-flex flex-column justify-content-end p-8">
                                    <h6 class="card-subtitle mb-1 text-white custom-font fs-48 lh-166 font-weight-normal">Assorted</h6>
                                    <h3 class="card-title fs-40 lh-13 text-white mb-6">Communion Items</h3>
                                    <div>
                                        <a href="<?php echo base_url();?>category/communion-items-o2zok9" class="fs-16 font-weight-600 btn text-white hover-white bg-secondary bg-hover-secondary shadow-1">Explore All</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card border-0 text-center hover-shine hover-zoom-in mb-5">
                                        <img src="<?php echo base_url();?>assets/landing/images/products/gold-wares.jpg" alt="Autumn Skincare" class="card-img" />
                                        <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                            <h4 class="card-title fs-28 text-white mb-3">
                                                Thurible
                                            </h4>
                                            <div>
                                                <a href="<?php echo base_url();?>category/silver-communion-wares-mtplqd" class="btn text-secondary hover-white bg-primary bg-hover-secondary shadow-1 border-0 py-1 fs-16 font-weight-600">
                                                    Shop Now
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 text-center hover-shine hover-zoom-in mb-5">
                                        <img src="<?php echo base_url();?>assets/landing/images/products/Chalice_Cup.jpg" alt="Anti-aging Cream" class="card-img" />
                                        <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                            <h4 class="card-title fs-28 text-white mb-3">Chalice Cups</h3>
                                            <div>
                                                <a href="<?php echo base_url();?>category/silver-cup-holders-vs04wr" class="btn text-secondary hover-white bg-primary bg-hover-secondary shadow-1 border-0 py-1 fs-16 font-weight-600">
                                                    Shop Now
                                                    <svg class="icon icon-arrow-right">
                                                        <use xlink:href="#icon-arrow-right"></use>
                                                    </svg>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 text-center hover-shine hover-zoom-in mb-5">
                                        <img src="<?php echo base_url();?>assets/landing/images/products/Efrat.jpg" alt="Autumn Skincare" class="card-img" />
                                        <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                            <h4 class="card-title fs-28 text-white mb-3">
                                                Altar Wine
                                            </h3>
                                            <div>
                                                <a href="<?php echo base_url();?>category/altar-wine-p8qol6" class="btn text-secondary hover-white bg-primary bg-hover-secondary shadow-1 border-0 py-1 fs-16 font-weight-600">
                                                    Shop Now
                                                    <svg class="icon icon-arrow-right">
                                                        <use xlink:href="#icon-arrow-right"></use>
                                                    </svg>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 text-center hover-shine hover-zoom-in mb-5">
                                        <img src="<?php echo base_url();?>assets/landing/images/products/Hosts.png" alt="Anti-aging Cream" class="card-img" />
                                        <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                            <h4 class="card-title fs-28 text-white mb-3">Wafers/Hosts</h3>
                                            <div>
                                                <a href="<?php echo base_url();?>category/wafers-hhxfe2" class="btn text-secondary hover-white bg-primary bg-hover-secondary shadow-1 border-0 py-1 fs-16 font-weight-600">
                                                    Shop Now
                                                    <svg class="icon icon-arrow-right">
                                                        <use xlink:href="#icon-arrow-right"></use>
                                                    </svg>
            ...
            <section class="mt-lg-10 mt-8 py-11" style="background-color: #fefaf4;">
                <div class="container">
                    <div class="slick-slider section-01" data-slick-options='{"slidesToShow": 1,"dots":false,"arrows":false,"asNavFor":".section-02"}'>
                        <div class="box" data-animate="fadeInUp">
                            <h4 class="mx-auto text-center mw-750 mb-0">“Bethany House has always been a great help whenever we need Holy Communion Supplies.”<br><small><small>~ Pst. Moses Mwicigi, The Good News Mission Church</small></small></h4>
                        </div>
                    </div>
                </div>
            </section>
            <section>
                <div class="container container-xl">
                    <div class="row mt-8 mb-6">
                        <div class="col-12 text-center" data-animate="fadeInUp">
                            <h2 class="mb-3">Clergy Apparels</h2>
                            <p class="fs-18 mx-auto lh-166" style="max-width: 800px;">We stock assorted clergy apparels and vestments including preaching gowns, shirts, collars, chasubles, cassocks, albs, cincture belts and ropes, stoles, bishop mitres, tallit prayer shawls and many more.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-7 order-2 order-lg-1">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 text-center hover-shine hover-zoom-in mb-5">
                                        <img src="<?php echo base_url();?>assets/landing/images/products/natasha1.jpg" alt="Chasubles" class="card-img" />
                                        <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                            <h4 class="card-title fs-28 text-white mb-3">
                                                Preaching Gowns
                                            </h4>
                                            <div>
                                                <a href="<?php echo base_url();?>category/preaching-gown-ddy49h" class="btn text-secondary hover-white bg-primary bg-hover-secondary shadow-1 border-0 py-1 fs-16 font-weight-600">
                                                    Shop Now
                                                    <svg class="icon icon-arrow-right">
                                                        <use xlink:href="#icon-arrow-right"></use>
                                                    </svg>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 text-center hover-shine hover-zoom-in mb-5">
                                        <img src="<?php echo base_url();?>assets/landing/images/products/preaching_gown1.jpg" alt="Clergy Shirts" class="card-img" />
                                        <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                            <h4 class="card-title fs-28 text-white mb-3">Albs</h3>
                                            <div>
                                                <a href="<?php echo base_url();?>category/clergy-shirts-pux37w" class="btn text-secondary hover-white bg-primary bg-hover-secondary shadow-1 border-0 py-1 fs-16 font-weight-600">
                                                    Shop Now
                                                    <svg class="icon icon-arrow-right">
                                                        <use xlink:href="#icon-arrow-right"></use>
                                                    </svg>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 text-center hover-shine hover-zoom-in mb-5">
                                        <img src="<?php echo base_url();?>assets/landing/images/products/bishop.jpeg" alt="Stoles" class="card-img" />
                                        <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                            <h4 class="card-title fs-28 text-white mb-3">
                                                Stoles
                                            </h3>
                                            <div>
                                                <a href="<?php echo base_url();?>category/stoles-bltxk4" class="btn text-secondary hover-white bg-primary bg-hover-secondary shadow-1 border-0 py-1 fs-16 font-weight-600">
                                                    Shop Now
                                                    <svg class="icon icon-arrow-right">
                                                        <use xlink:href="#icon-arrow-right"></use>
                                                    </svg>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 text-center hover-shine hover-zoom-in mb-5">
                                        <img src="<?php echo base_url();?>assets/landing/images/products/cassock212.jpg" alt="Cassocks" class="card-img" />
                                        <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                            <h4 class="card-title fs-28 text-white mb-3">Clergy Vestments</h3>
                                            <div>
                                                <a href="<?php echo base_url();?>category/cassocks-6sdr0e" class="btn text-secondary hover-white bg-primary bg-hover-secondary shadow-1 border-0 py-1 fs-16 font-weight-600">
                                                    Shop Now
                                                    <svg class="icon icon-arrow-right">
                                                        <use xlink:href="#icon-arrow-right"></use>
                                                    </svg>
                        ...
                        <div class="col-lg-4 mb-8 mb-lg-0 order-1 order-lg-2" data-animate="fadeInRight">
                            <div class="card border-0 hover-shine hover-zoom-in banner banner-04">
                                <div class="card-img bg-img-cover-center" style="background-image: url('<?php echo base_url();?>assets/landing/images/3.jpg');"></div>
                                <div class="card-img-overlay d-inline-flex flex-column justify-content-end p-8">
                                    <h6 class="card-subtitle mb-1 text-white custom-font fs-48 lh-166 font-weight-normal">Clergy</h6>
                                    <h3 class="card-title fs-40 lh-13 text-white mb-6">Apparels / Vestments</h3>
                                    <div>
                                        <a href="<?php echo base_url();?>category/clergy-apparels-fofem6" class="fs-16 font-weight-600 btn text-secondary hover-white bg-white bg-hover-secondary shadow-1">Explore All</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="pt-7 pt-lg-10 pt-xl-14">
                <div class="container container-xl">                    
                    <div class="row">
                        <div class="col-lg-4 mb-6 mb-lg-0" data-animate="fadeInUp">
                            <div class="media border-0">
                                <div class="mw-90 mr-6">
                                    ...
                                    <img src="<?php echo base_url();?>assets/landing/images/image-box-18.jpg" alt="" />
                                </div>
                                <div class="media-body">
                                    <h3 class="fs-24 mb-3">Free Delivery</h3>
                                    <p class="mb-0 pr-lg-8">Within Nairobi & for orders above KES 2,000/-</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 mb-6 mb-lg-0" data-animate="fadeInUp">
                            <div class="media border-0">
                                <div class="mw-90 mr-6">
                                    <img src="<?php echo base_url();?>assets/landing/images/image-box-19.jpg" alt="" />
                                </div>
                                <div class="media-body">
                                    <h3 class="fs-24 mb-3">International Shipping</h3>
                                    <p class="mb-0 pr-lg-8">We ship across East Africa. We can organize shipping for other regions as well</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 mb-6 mb-lg-0" data-animate="fadeInUp">
                            <div class="media border-0">
                                <div class="mw-90 mr-6">
                                    <img src="<?php echo base_url();?>assets/landing/images/image-box-20.jpg" alt="" />
                                </div>
                                <div class="media-body">
                                    <h3 class="fs-24 mb-3">24/7 Support</h3>
                                    <p class="mb-0 pr-lg-8">Dedicated support</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="pt-7 pt-lg-15">
                <div class="container-fluid">
                    <div class="row mt-0 mb-6">
                        <div class="col-12 text-center" data-animate="fadeInUp">
                            <h3 class="mb-3">More Gifts and Accessories...</h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-md-2 mb-6 mb-md-0" data-animate="fadeInUp"></div>
                        <div class="col-12 col-md-2 mb-6 mb-md-0" data-animate="fadeInUp">
                            <div class="card border-0 text-center hover-shine hover-zoom-in">
                                <img src="<?php echo base_url();?>assets/landing/images/products/cross.jpeg" alt="Pectoral Crosses" class="card-img" />
                                <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                    <h3 class="card-title fs-24 text-white mb-3">
                                        Pectoral Crosses
                                    </h3>
                                    <div>
                                        <a href="<?php echo base_url();?>product/pectoral-cross-large-6y8dopm2s" class="btn btn-link btn-light bg-transparent text-white hover-white border-0 p-0 fs-16 font-weight-600">
                                            Explore
                                            <svg class="icon icon-arrow-right">
                                                <use xlink:href="#icon-arrow-right"></use>
                                            </svg>
                        ...
                        <div class="col-12 col-md-2 mb-6 mb-md-0" data-animate="fadeInUp">
                            <div class="card border-0 text-center hover-shine hover-zoom-in">
                                <img src="<?php echo base_url();?>assets/landing/images/products/365days.png" alt="NIV Bibles" class="card-img" />
                                <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                    <h3 class="card-title fs-24 text-white mb-3">Children's Bibles</h3>
                                    <div>
                                        <a href="<?php echo base_url();?>product/niv-holy-bible-1seb6y7z1" class="btn btn-link btn-light bg-transparent text-white hover-white border-0 p-0 fs-16 font-weight-600">
                                            Explore
                                            <svg class="icon icon-arrow-right">
                                                <use xlink:href="#icon-arrow-right"></use>
                                            </svg>
                        ...
                        <div class="col-12 col-md-2 mb-md-0" data-animate="fadeInUp">
                            <div class="card border-0 text-center hover-shine hover-zoom-in">
                                <img src="<?php echo base_url();?>assets/landing/images/products/usher.jpg" alt="Ushering Belts" class="card-img" />
                                <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                    <h3 class="card-title fs-24 text-white mb-3">Ushering Belts</h3>
                                    <div>
                                        <a href="<?php echo base_url();?>product/usher-belts-1dtpemw9l" class="btn btn-link btn-light bg-transparent text-white hover-white border-0 p-0 fs-16 font-weight-600">
                                            Explore
                                            <svg class="icon icon-arrow-right">
                                                <use xlink:href="#icon-arrow-right"></use>
                                            </svg>
                        ...
                        <div class="col-12 col-md-2 mb-md-0" data-animate="fadeInUp">
                            <div class="card border-0 text-center hover-shine hover-zoom-in">
                                <img src="<?php echo base_url();?>assets/landing/images/products/tallit1.png" alt="Tallit (Prayer Shawl)" class="card-img" />
                                <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                    <h3 class="card-title fs-24 text-white mb-3">Tallit (Prayer Shawl)</h3>
                                    <div>
                                        <a href="<?php echo base_url();?>product/tallit-prayer-shawl-large-ze3sr3d47" class="btn btn-link btn-light bg-transparent text-white hover-white border-0 p-0 fs-16 font-weight-600">
                                            Explore
                                            <svg class="icon icon-arrow-right">
                                                <use xlink:href="#icon-arrow-right"></use>
                                            </svg>
        ...
        <footer class="pt-10 pt-lg-14 pb-11 footer">
            <div class="container container-xl">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-12 mb-7 mb-lg-0">
                        <h3 class="fs-20 mb-3">Contact Us</h3>
                        <p class="fs-14 lh-185 pr-xl-12">
                            <?php foreach ($store_information as $row): ?>
                                <b><i class="fa fa-phone"></i></b> <?php echo $row->phone_number; ?><?php if ($row->mobile_number != ''){ echo ' / ' . $row->mobile_number; } ?><br>
                                <b><i class="fa fa-envelope"></i></b> <?php echo $row->email_address; ?><br>
                                <b><i class="fa fa-map-marker"></i></b> <?php echo $row->physical_address; ?><br>
                                <?php if ($row->opening_hours != ''): ?>
                                    <b><i class="fa fa-clock"></i></b> <?php echo $row->opening_hours; ?>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        </p>
                    </div>
                    <div class="col-lg col-md-4 col-12 mb-7 mb-lg-0">
                        <h3 class="fs-20 mb-3">Help Center</h3>
                        <ul class="list-unstyled mb-0">
                            <li class="pb-1"><a href="<?php echo base_url(); ?>track" class="text-body lh-175">Track Order</a></li>
                            <li class="py-1"><a href="<?php echo base_url(); ?>how-to-shop" class="text-body lh-175">How to Shop</a></li>
                            <li class="py-1"><a href="<?php echo base_url(); ?>faqs" class="text-body lh-175">Frequently Asked Questions</a></li>
                            <li class="pt-1"><a href="<?php echo base_url(); ?>contact-us" class="text-body lh-175">Contact Us</a></li>
                        </ul>
                    </div>
                    <div class="col-lg col-md-4 col-12 mb-7 mb-lg-0">
                        <h3 class="fs-20 mb-3">Account</h3>
                        <ul class="list-unstyled mb-0">
                            <li class="pb-1"><a href="<?php echo base_url(); ?>account" class="text-body lh-175">My Account</a></li>
                            <li class="py-1"><a href="<?php echo base_url(); ?>account/orders" class="text-body lh-175">My Orders</a></li>
                            <li class="py-1"><a href="<?php echo base_url(); ?>account/favorites" class="text-body lh-175">My Favorites</a></li>
                            <li class="py-1"><a href="<?php echo base_url(); ?>cart" class="text-body lh-175">Shopping Cart</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-4 col-md-4 col-12 mb-9 mb-lg-0">
                        <h3 class="mb-2">Newsletter</h3>
                        <p class="lh-2">Enter your email below to be the first to know about any good news from Bethany House.</p>
                        <form class="pt-0">
                ...
                <div class="row mt-0 mt-lg-15 align-items-center">
                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-center order-2 order-lg-1 mt-4 mt-md-7 mt-lg-0">
                        <p class="mb-0">© <?php echo date('Y'); ?> Bethany House</p>
                        <ul class="list-inline fs-18 ml-3 mb-0">
                            <?php foreach ($store_information as $row): ?>
                                <?php if ($row->sm_facebook != ''): ?>
                                    <li class="list-inline-item mr-4"><a class="facebook" href="<?php echo $row->sm_facebook; ?>" target="_blank"><i class="fab fa-facebook"></i></a></li>
                                <?php endif; ?>
                                <?php if ($row->sm_twitter != ''): ?>
                                    <li class="list-inline-item mr-4"><a class="twitter" href="<?php echo $row->sm_twitter; ?>" target="_blank"><i class="fab fa-twitter"></i></a></li>
                                <?php endif; ?>
                                <?php if ($row->sm_instagram != ''): ?>
                                    <li class="list-inline-item mr-4"><a class="instagram" href="<?php echo $row->sm_instagram; ?>" target="_blank"><i class="fab fa-instagram"></i></a></li>
                                <?php endif; ?>
                                <?php if ($row->sm_youtube != ''): ?>
                                    <li class="list-inline-item mr-4"><a class="youtube" href="<?php echo $row->sm_youtube; ?>" target="_blank"><i class="fab fa-youtube"></i></a></li>
                                <?php endif; ?>
                                <?php if ($row->sm_linkedin != ''): ?>
                                    <li class="list-inline-item"><a class="linkedin" href="<?php echo $row->sm_linkedin; ?>" target="_blank"><i class="fab fa-linkedin"></i></a></li>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        </ul>
                    </div>
        ...
        <script src="<?php echo base_url();?>assets/landing/vendors/jquery.min.js"></script>
        <script src="<?php echo base_url();?>assets/landing/vendors/jquery-ui/jquery-ui.min.js"></script>
        <script src="<?php echo base_url();?>assets/landing/vendors/bootstrap/bootstrap.bundle.js"></script>
        <script src="<?php echo base_url();?>assets/landing/vendors/bootstrap-select/js/bootstrap-select.min.js"></script>
        <script src="<?php echo base_url();?>assets/landing/vendors/slick/slick.min.js"></script>
        <script src="<?php echo base_url();?>assets/landing/vendors/waypoints/jquery.waypoints.min.js"></script>
        <script src="<?php echo base_url();?>assets/landing/vendors/counter/countUp.js"></script>
        <script src="<?php echo base_url();?>assets/landing/vendors/magnific-popup/jquery.magnific-popup.min.js"></script>
        <script src="<?php echo base_url();?>assets/landing/vendors/hc-sticky/hc-sticky.min.js"></script>
        <script src="<?php echo base_url();?>assets/landing/vendors/jparallax/TweenMax.min.js"></script>
        <script src="<?php echo base_url();?>assets/landing/vendors/mapbox-gl/mapbox-gl.js"></script>
        <script src="<?php echo base_url();?>assets/landing/vendors/isotope/isotope.js"></script>

        <script src="<?php echo base_url();?>assets/landing/js/theme.js"></script>
        
        <svg aria-hidden="true" style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="../../external.html?link=http://www.w3.org/1999/xlink">
            <defs>
        ...
        <div class="position-fixed pos-fixed-bottom-right p-6 z-index-10">
            <a href="#" class="gtf-back-to-top text-decoration-none bg-white text-primary hover-white bg-hover-primary shadow p-0 w-48px h-48px rounded-circle fs-20 d-flex align-items-center justify-content-center" title="Back To Top">
            ...
            <div class="pt-5 pb-7 card border-0 h-100">
                ...
                <div class="overflow-y-auto pb-6 pl-8 pr-7 card-body pt-0">
                    <ul class="navbar-nav main-menu px-0">
                        ...
                        <li aria-haspopup="true" aria-expanded="false" class="nav-item dropdown-item-home dropdown py-1 px-0">
                            <a class="nav-link dropdown-toggle p-0" href="index.html" data-toggle="dropdown">
                                About Us
                                <span class="caret"></span>
                            </a>
                ...
                <div class="card-footer bg-transparent border-0 mt-auto pl-8 pr-7 pb-0 pt-4">
                    ...
                    <p class="mb-0 text-gray">
                        © <?php echo date('Y'); ?> Bethany House.<br />
                        All rights reserved.
                    </p>
                </div>
            </div>
