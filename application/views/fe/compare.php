<div class="ps-page--simple">
        ...
        <div class="ps-compare ps-section--shopping">
            <div class="container">
                ...
                <div id="div_compare_products" style="min-height: 300px" class="ps-section__content">
                                                    ...
                                                    <div class="ps-product__thumbnail">
                                                        <a href="<?php echo base_url(); ?>product/<?php echo $row->product_reference_id; ?>">
                                                            <?php if($row->product_image_thumb != '' && file_exists("./uploads/product_images/thumbs/" . $row->product_image_thumb)): ?>
                                                                <img class="lazyload" data-src="<?php echo base_url();?>uploads/product_images/thumbs/<?php echo $row->product_image_thumb; ?>" src="<?php echo product_placeholder; ?>">
                                                            <?php else: ?>
