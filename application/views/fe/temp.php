...
<html lang="en">
    ...
    <head>
        ...
        <!-- Global site tag (gtag.js) - Google Analytics -->
            <script async src="https://www.googletagmanager.com/gtag/js?id=UA-227860423-1">
            </script>
            <script>
     ...
     <!-- Global site tag (gtag.js) - Google Analytics -->
            <script async src="https://www.googletagmanager.com/gtag/js?id=G-EYCR6DJTDE"></script>
            <script>
              window.dataLayer = window.dataLayer || [];
              function gtag(){dataLayer.push(arguments);}
              gtag('js', new Date());
            
              gtag('config', 'G-EYCR6DJTDE');
            </script>
        ...
        <main id="content">
            <section>
                <div class="slick-slider mx-0 slider" data-slick-options='{"slidesToShow": 1,"infinite":true,"autoplay":true,"dots":false,"arrows":false,"fade":true,"cssEase":"ease-in-out","speed":600}'>
                    <div class="box px-0">
                        <div class="bg-img-cover-center py-12 pt-lg-18 pb-lg-17" style="background-image: url('<?php echo base_url();?>assets/landing/images/bg-slider2.jpg');">
                            <div class="container container-xl py-7">
                                ...
                                <div class="text-center" style="max-width: 454px;" data-animate="fadeInUp">
                                    <a href="<?php echo base_url();?>home" class="btn btn-secondary rounded bg-hover-primary border-0">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 text-center hover-shine hover-zoom-in mb-5">
                                        <img src="<?php echo base_url();?>assets/landing/images/products/Altar_wine.jpg" alt="Autumn Skincare" class="card-img" />
                                        <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                            <h4 class="card-title fs-28 text-white mb-3">
                                                Altar Wines/Devai
                                            </h3>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 text-center hover-shine hover-zoom-in mb-5">
                                        <img src="<?php echo base_url();?>assets/landing/images/products/Hosts.jpg" alt="Anti-aging Cream" class="card-img" />
                                        <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                    ...
                    <div class="row">
                        <div class="col-lg-7 order-2 order-lg-1">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 text-center hover-shine hover-zoom-in mb-5">
                                        <img src="<?php echo base_url();?>assets/landing/images/products/preaching_gown1.jpg" alt="Chasubles" class="card-img" />
                                        <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                            <h4 class="card-title fs-28 text-white mb-3">
                                                Preaching Gowns
                                            </h4>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 text-center hover-shine hover-zoom-in mb-5">
                                        <img src="<?php echo base_url();?>assets/landing/images/products/Shirt11.jpg" alt="Clergy Shirts" class="card-img" />
                                        <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                            <h4 class="card-title fs-28 text-white mb-3">Clergy Shirts</h3>
                                            <div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 text-center hover-shine hover-zoom-in mb-5">
                                        <img src="<?php echo base_url();?>assets/landing/images/products/Stoles5.jpg" alt="Stoles" class="card-img" />
                                        <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                            <h4 class="card-title fs-28 text-white mb-3">
                                                Stoles
                                            </h3>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border-0 text-center hover-shine hover-zoom-in mb-5">
                                        ...
                                        <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                            <h4 class="card-title fs-28 text-white mb-3">Cassocks</h3>
                                            <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-2 mb-6 mb-md-0" data-animate="fadeInUp">
                            <div class="card border-0 text-center hover-shine hover-zoom-in">
                                <img src="<?php echo base_url();?>assets/landing/images/products/cross1.jpg" alt="Pectoral Crosses" class="card-img" />
                                <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                        ...
                        <div class="col-12 col-md-2 mb-6 mb-md-0" data-animate="fadeInUp">
                            <div class="card border-0 text-center hover-shine hover-zoom-in">
                                <img src="<?php echo base_url();?>assets/landing/images/products/niv_bible.jpg" alt="NIV Bibles" class="card-img" />
                                <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
                                    <h3 class="card-title fs-24 text-white mb-3">NIV Bibles</h3>
                                    <div>
                        ...
                        <div class="col-12 col-md-2 mb-md-0" data-animate="fadeInUp">
                            <div class="card border-0 text-center hover-shine hover-zoom-in">
                                <img src="<?php echo base_url();?>assets/landing/images/products/tallit.jpg" alt="Tallit (Prayer Shawl)" class="card-img" />
                                <div class="card-img-overlay d-inline-flex flex-column p-6 justify-content-end">
