            	...
            	<div class="nk-block nk-block-lg">
                    <div class="nk-block-head nk-block-head-sm">
					    <div class="nk-block-between">
					        <div class="nk-block-head-content"><h5 class="nk-block-title page-title"><em class="icon ni ni-file-docs"></em> Sales Detailed Report</h5></div>
					    </div>
					</div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-success">
                                ...
                                <form id="frm_sales_detailed_report_filter" name="frm_sales_detailed_report_filter" onsubmit="return load_sales_detailed_report();">
                                    <div class="box-body">
                                    ...
                                    <div class="box-footer">
                                        <div class="col-sm-12 text-center">
                                            <div class="col-md-5 col-md-offset-3">
                                                <button type="submit" id="btn_view_sales_detailed_report" class="btn btn-primary"><em class="icon ni ni-reload-alt mr-1"></em>Generate Report</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="card card-preview">
                    	<div class="spinner display-none" id="sales_detailed_report_loader">
                            <div class="rect1"></div>
                            <div class="rect2"></div>
                            <div class="rect3"></div>
                        </div>
                        ...
                        <div class="card-inner" id="div_sales_detailed_report">
