                                        ...
                                        <div class="register-box register-summary paper-cut">
                                            ...
                                            <div class="sale_controls">
                                                ...
                                                <button type="button" id="btn_complete_sales_return" class="btn btn-success mt-1 mb-1 ml-1">
                                                    <i class="ion-checkmark-circled mr-1"></i>Submit
                                                </button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="frm_set_sales_return_date" name="frm_set_sales_return_date" method="post" class="is-alter" onsubmit="return submit_sales_return_date();">
                    ...
                    <input type="hidden" id="date_pos_sales_return_id" name="pos_sales_return_id">
                                    ...
                                    <div class="row mt-1">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" id="date_sales_return_date" name="sales_return_date" class="form-control datepicker" placeholder="Sales Return Date">
                                            </div>
                                        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="frm_modify_sales_return_item" name="frm_modify_sales_return_item" method="post" class="is-alter" onsubmit="return submit_modify_sales_return_item();">
                    ...
                    <input type="hidden" id="mod_pos_sale_return_id" name="pos_sales_return_id">
...
<div class="modal fade" tabindex="-1" id="modal_sales_return_add_customer">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="spinner display-none" id="sales_return_add_customer_loader">
                    <div class="rect1"></div>
                    <div class="rect2"></div>
                    <div class="rect3"></div>
                </div>
                <form id="frm_sales_return_add_customer" name="frm_sales_return_add_customer" method="post" class="is-alter" onsubmit="return submit_sales_return_add_customer();">

                    <input type="hidden" id="mod_ac_pos_sales_return_id" name="pos_sales_return_id">
                            ...
                            <div class="box box-solid bg-lighter">
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="customer_phone_number">Phone Number<span class="text-danger">*</span> <small>(Format: 0700912916)</small></label>
