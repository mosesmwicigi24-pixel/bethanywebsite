                ...
                <?php foreach ($pos_sale as $row): ?>
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content"><h5 class="nk-block-title"><em class="icon ni ni-edit"></em> Edit Sales Order [<?php echo $row->pos_sale_number; ?>]</h5></div>
                                        ...
                                        <div class="col-lg-4 col-md-5 col-sm-12 col-xs-12">
                                                    ...
                                                    <?php if ($row->sale_type == 'CASH SALE'): ?>
                                                        <div class="customer-badge">
                                                            <div class="details pl-0">
                                                                <a href="#" class="name">Customer Name: <big class="text-info"><strong><?php echo $row->customer_name; ?></strong></big></a>                                    
                                                        ...
                                                        <div class="customer-action-buttons btn-group btn-group-justified">
                                                            <a href="#" id="btn_remove_customer_name" data-pos-sale-id="<?php echo $row->pos_sale_id; ?>" class="btn"><i class="ion-close-circled"></i> Remove</a>
                                                        </div>
                                                    <?php else: ?>
                                            ...
                                            <div class="register-box register-summary paper-cut">
                                                ...
                                                <div class="comment-block">
                                                    <big><a href="#" id="edit_lnk_sale_comments" class="xeditable editable editable-click editable-empty"><em class="icon ni ni-comments mr-1"></em>Comments</a></big>
                                                    ...
                                                    <ul class="list-group payments mb-0">
                                                        ...
                                                        <?php foreach ($pos_sale_payments as $row2): ?>
                                                            <li class="list-group-item">
                                                                <span class="key">
                                                                    <a href="javascript:;" class="remove text-info lnk_modify_sale_payment" data-pos-payment-id="<?php echo $row2->pos_payment_id; ?>" data-toggle="tooltip" data-placement="top" title="Modify Payment"><i class="icon ti-pencil-alt"></i></a>
                                                ...
                                                <div class="sale_controls">
                                                    <button type="button" id="edit_btn_make_payment" data-pos-sale-id="<?php echo $row->pos_sale_id; ?>" data-context="Edit Sale" class="btn btn-info mt-1 mb-1 ml-1 edit_btn_make_payment">
                                                ...
                                                <input type="hidden" id="pos_sale_id" name="pos_sale_id" value="<?php echo $row->pos_sale_id; ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control only_currency" id="mod_discount_value" name="discount_value" placeholder="" step="any" value="0" required />
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="frm_change_sale_type" name="frm_change_sale_type" method="post" class="is-alter" onsubmit="return submit_change_sale_type();">
                    ...
                    <input type="hidden" id="saletype_transaction_type" name="transaction_type" value="Edit">
                            ...
                            <div class="box box-solid bg-lighter">
                                <div class="box-body">
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="number" class="form-control only_currency" id="del_delivery_fee" name="delivery_fee" placeholder="" value="0" step="any" required />
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="frm_enter_customer_name" name="frm_enter_customer_name" method="post" class="is-alter" onsubmit="return submit_enter_customer_name();">
                    ...
                    <input type="hidden" id="customer_name_transaction_type" name="customer_name_transaction_type" value="Edit">
