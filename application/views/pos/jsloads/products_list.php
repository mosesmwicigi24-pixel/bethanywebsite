                            ...
                            <table class="datatable-init nk-tb-list nk-tb-ulist table" data-auto-responsive="true">
                                <thead class="bg-lighter">
                                    <tr class="nk-tb-item nk-tb-head">
                                        ...
                                        <th class="nk-tb-col"><span class="">Image</span></th>
                                        <th class="nk-tb-col tb-col-mb"><span class="">Product Name</span></th>
                                        <th class="nk-tb-col tb-col-md"><span class="">Categories</span></th>
                                        <th class="nk-tb-col tb-col-md"><span class="">Brand</span></th>
                                        <!-- <th class="nk-tb-col tb-col-lg"><span class="">Unit</span></th> -->
                                        <th class="nk-tb-col tb-col-lg"><span class="">Price</span></th>
                                        <th class="nk-tb-col tb-col-md"><span class="">Stock</span></th>
