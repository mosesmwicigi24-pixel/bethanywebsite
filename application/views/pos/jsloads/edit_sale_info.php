                                        ...
                                        <div class="col-lg-4 col-md-5 col-sm-12 col-xs-12">
                                            ...
                                            <div id="div_sale_customer_info" class="register-box register-right">
                                                ...
                                                <?php if ($row->customer_id != 0): ?>
                                                    ...
                                                    <div class="customer-badge">
                                                        ...
                                                        <div class="details">
                                                            <a href="javascript:;" data-toggle="modal" data-target="#myModal" class="name"><?php echo $row->first_name . ' ' . $row->last_name; ?></a>                                    
                                                            ...
                                                            <a href="#" id="edit_customer" class="btn btn-edit btn-primary pull-right" title="Edit Customer"><i class="ti-pencil-alt"></i></a>
                                                        </div>
                                                    </div>

                                                    <div class="customer-action-buttons btn-group btn-group-justified">
                                                        <a href="#" id="btn_detatch_customer" data-pos-sale-id="<?php echo $row->pos_sale_id; ?>" class="btn"><i class="ion-close-circled"></i> Detach Customer</a>
                                                    </div>
                                            ...
                                            <div class="register-box register-summary paper-cut">
                                                ...
                                                <div class="sale_controls">
                                                    <button type="button" id="edit_btn_make_payment" class="btn btn-info mt-1 mb-1 ml-1">
