                            ...
                            <td width="50%" style="border: 0px">
                                ...
                                <?php foreach ($store_information as $row2): ?>
                                    <span>
                                        ...
                                        <?php echo $row2->phone_number; ?> ||  <?php echo $row2->mobile_number; ?><br />
                                        <?php echo $row2->email_address; ?><br />
                                    </span>
                                <?php endforeach; ?>
                            </td>
                            <td width="50%" class="text-right" style="border: 0px">
                                <h3 class="text-uppercase text-normal mb-0">Sales Order<br><small class="text-primary"><?php echo $row->pos_sale_number; ?></small></h3>
                                <br>
                                <p class="mb-0">
                    ...
                    <table class="table" style="margin-bottom: 0px;">
                        <tr>
                            <td width="100%" style="border: 0px; text-align: center; font-size: 11px">
                                POS powered by Gerd Africa | www.gerdafrica.com | +254 700706875
                            </td>
                        </tr>
                    </table>
                </div>
