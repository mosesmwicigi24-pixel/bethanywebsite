                    ...
                    <table class="table" style="margin-bottom: 0px;">
                        <tr>
                            ...
                            <td width="50%" class="text-right" style="border: 0px">
                                <h3 class="text-uppercase text-normal mb-0">Sales Return<br><small class="text-primary"><?php echo $row->pos_sales_return_number; ?></small></h3>
                                <br>
                                <p class="mb-0">
                                ...
                                <p style="font-size: 12px">
                                    <b>Return Date:</b> <?php echo date('d M, Y', strtotime($row->sales_return_date)); ?><br />
                                    <b>Status:</b> 
                                    ...
                                    <?php if ($row->return_status == 1): ?>
                                        ...
                                        <?php if ($row->return_settlement == 'Refund'): ?>
                                            ...
                                            <?php if ($refund_balance == $row->total_amount): ?>
                                                <span class="">Not Refunded</span>
                                            <?php elseif ($refund_balance > 0): ?>
                                                <span class="">Partially Refunded</span>
                                            <?php else: ?>
                            ...
                            <?php if ($row->return_status == 1 && $row->return_settlement == 'Refund'): ?>
                                ...
                                <?php if ($refund_balance < 0): ?>
                                    <tr>
                                        ...
                                        <th><?php echo number_format(($refund_balance * -1),2); ?></th>
                                    </tr>
                                <?php elseif ($refund_balance > 0): ?>
                                    <tr>
                        ...
                        <tr>
                            ...
                            <td width="50%" style="border: 0px">
                                <?php if ($num_pos_sales_return_refunds > 0): ?>
                                    <h5 class="text-uppercase" style="margin-bottom: 3px;">refunds</h5>
                                    <table class="table table-condensed table-striped" style="margin-bottom: 0px; font-size: 12px;">
                                        <thead>
                                            <tr class="">
                                                <th>Date</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><b><?php echo number_format($total_paid,2); ?></b></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                <?php endif; ?>
