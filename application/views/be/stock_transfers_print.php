                ...
                <table class="table" style="margin-bottom: 0px;">
                    <tr>
                        ...
                        <td width="50%" class="text-right" style="border: 0px">
                            <h3 class="text-uppercase text-normal mb-0">Stock Transfer<br><small class="text-primary"><?php //echo $row->pos_sale_number; ?></small></h3>
                            ...
                            <p style="font-size: 12px">
                                ...
                                <?php endif; ?>  
                                <?php if ($source_outlet_id != ''): ?>
                                    <b>Source Outlet:</b> <?php echo $source_outlet_name; ?><br />
                                <?php endif; ?>
                                <?php if ($destination_outlet_id != ''): ?>
                                    <b>Destination Outlet:</b> <?php echo $destination_outlet_name; ?><br />
                                <?php endif; ?>
            ...
            <tbody> 
                ...
                <?php foreach ($stock_transfers as $row): ?>
                    <tr class="<?php if ($row->is_void == 1){ echo 'text-muted'; } ?>">    
                        ...
                        <td><?php echo $row->stock_transfer_number; ?></td>
