							...
							<div class="card">
								...
								<div class="card-body p-0">
									<ul class="nav nav-sidebar" data-nav-type="accordion">
										<li class="nav-item-header text-green-800"><b>Store Information</b></li>
										<li class="nav-item">
											<a href="<?php echo base_url();?>be/settings/store_information" class="nav-link active"><i class="icon-circle-small"></i> Store Information</a>
										</li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="icon-circle-small"></i> Outlets</a>
										</li>
										<li class="nav-item-header text-green-800"><b>Locations</b></li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="icon-circle-small"></i> Countries, Cities &amp; Localities</a>
										</li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="icon-circle-small"></i> Pickup Locations</a>
										</li>
										<li class="nav-item-header text-green-800"><b>Money &amp; Payments</b></li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="icon-circle-small"></i> Currencies</a>
										</li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="icon-circle-small"></i> Banks &amp; Bank Branches</a>
										</li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="icon-circle-small"></i> Tax Rates</a>
										</li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="icon-circle-small"></i> Credit Terms</a>
										</li>
										<!-- <li class="nav-item">
											<a href="#" class="nav-link"><i class="icon-circle-small"></i> Payment Options</a>
										</li> -->
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="icon-circle-small"></i> M-Pesa Settings</a>
										</li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="icon-circle-small"></i> Tax Rates</a>
										</li>
										<li class="nav-item-header text-green-800"><b>Communication</b></li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="icon-circle-small"></i> Email Settings</a>
										</li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="icon-circle-small"></i> Email Templates</a>
										</li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="icon-circle-small"></i> Bulk SMS Settings</a>
										</li>
										<li class="nav-item-header text-green-800"><b>Other Settings</b></li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="icon-circle-small"></i> Prefixes</a>
										</li>
										<li class="nav-item">
											<a href="#" class="nav-link"><i class="icon-circle-small"></i> Void Reasons</a>
										</li>
									</ul>
								</div>
							</div>
