...
<html>
    ...
    <body>
                ...
                <table class="table" style="margin-bottom: 0px;">
                    <tr>
                        ...
                        <td width="50%" class="text-right" style="border: 0px">
                            <h3 class="text-uppercase text-normal mb-0">Goods Receipt Notes<br><small class="text-primary"><?php //echo $row->pos_sale_number; ?></small></h3>
        ...
        <table class="table table-condensed" data-auto-responsive="true">
            ...
            <tbody> 
                ...
                <?php foreach ($goods_receipt_notes as $row): ?>
                    <tr class="<?php if ($row->is_void == 1){ echo 'text-muted'; } ?>">    
                        ...
                        <td><?php echo $row->goods_receipt_note_number; ?></td>
                        <td><?php echo date('d M, Y', strtotime($row->receival_date)); ?></td>
            ...
            <tfoot>
                <tr>
                    <th class="font-weight-bold" colspan="6" style="text-align:right">Total:</th>
