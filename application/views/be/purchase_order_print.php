                ...
                <div class="col-md-12">
                    <table class="table table-condensed table-bordered table-striped" style="margin-bottom: 0px;">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <th colspan="7" class="text-right">Tax Total:</b></th>
                                <th><?php echo number_format($row->tax_amount,2); ?></th>
                            </tr>

                            <tr>
                                <th colspan="7" class="text-right">Freight Cost:</th>
                                <th><?php echo number_format($row->freight_cost,2); ?></th>
                            </tr>

                            <tr>
                                <th colspan="7" class="text-right"><big>Total:</big></th>
                                <th><big><?php echo number_format($row->total_amount,2); ?></big></th>
                            </tr>

                            <tr>
                                <th colspan="7" class="text-right">Paid Amount:</th>
                        ...
                        <tr>
                            <td width="40%" style="border: 0px">
                                <?php if ($num_purchase_order_tax_details > 0): ?>
                                    ...
                                    <table class="table table-condensed table-striped" style="margin-bottom: 0px; font-size: 11px;">
                                        <thead>
                                            <tr>
                                                <th width="20%">Code</th>
                                                <th width="20%">Rate</th>
                            ...
                            <td width="60%" style="border: 0px">
                                <?php if ($num_purchase_order_payments > 0): ?>
                                    <h5 class="text-uppercase" style="margin-bottom: 3px;">Payments</h5>
                                    <table class="table table-condensed table-striped" style="margin-bottom: 0px; font-size: 11px;">
                                        <thead>
                                            <tr class="">
                                                <th>Date</th>
