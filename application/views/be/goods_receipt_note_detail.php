		...
		<div class="content-wrapper">
				...
				<?php foreach ($goods_receipt_note as $row): ?>
						...
						<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
							<div class="d-flex">
								<div class="breadcrumb">
									...
									<span class="breadcrumb-item active">View Goods Receipt Note (<?php echo $row->goods_receipt_note_number; ?>)</span>
								</div>
					...
					<div class="content pt-0">
						<div class="row mb-4">
							<div class="col-md-6">
								<h4 class="text-primary font-weight-bold"><i class="icon-eye"></i> View Goods Receipt Note (<?php echo $row->goods_receipt_note_number; ?>)</h4>
							</div>
							<div class="col-md-6 text-right">
								<a href="<?php echo base_url(); ?>be/inventory/goods_receipt_notes" class="btn btn-primary btn-sm"><i class="icon-arrow-left15"></i><span>Goods Receipt Notes List</span></a>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-md-8">
								<div class="invoice card card-preview p-3">
									<div class="spinner2 display-none" id="goods_receipt_notes_loader">
				                        <div class="rect1"></div>
				                        <div class="rect2"></div>
				                        <div class="rect3"></div>
				                    </div>
										...
										<div class="row mb-2">
								            <div class="col-md-12 text-right">
						                    	...
						                    	<div class="dropdown-menu dropdown-menu-right">
													...
													<?php endif; ?>
													<!-- <a href="<?php echo base_url(); ?>be/inventory/goods_receipt_note_pdf/<?php echo $row->goods_receipt_note_id; ?>" class="dropdown-item" target="_blank"><i class="icon-file-pdf"></i> Export to PDF</a> -->
													...
													<?php if ($row->is_void == 0): ?>
														<?php if ($sbr_goods_received_delete == true): ?>
															<a href="javascript:;" class="dropdown-item void-goods-receipt-note" data-goods-receipt-note-id="<?php echo $row->goods_receipt_note_id; ?>" data-context="View Goods Receipt Note"><i class="icon-trash-alt"></i> Void Goods Receipt Note</a>
														<?php endif; ?>
													<?php endif; ?>
						                    	</div>
						                    </div>
											...
											<div class="col-sm-6">
												<div class="mb-0">
													<div class="text-sm-right">
														<h2 class="text-uppercase font-weight-light mb-0">Goods Receipt Note</h2>
								            			<p class="lead text-info"><?php echo $row->goods_receipt_note_number; ?></p>

								            			<p class="mb-3">
										                	<b>Receival Date:</b> <?php echo date('d M, Y', strtotime($row->receival_date)); ?><br />
								            				<b>Receiving Outlet:</b> <?php echo $row->outlet_name; ?><br />
										                	<?php if ($row->purchase_order_number != ''): ?>
																<b>Purchase Order:</b> <?php echo $row->purchase_order_number; ?><br />
															<?php endif; ?>
									    ...
									    <table class="table table-striped table-bordered">
									        <thead>
									            <tr>
									                ...
									                <th>Base Qty</th>
									                <th>Base Unit Cost (<?php echo $default_currency; ?>)</th>
									                <th>Total Cost (<?php echo $default_currency; ?>)</th>
									            </tr>
									        </thead>
									        <tbody>
									        	<?php foreach ($goods_receipt_note_details as $row2): ?>
										            <tr>
										                ...
										                <td><?php echo number_format($row2->base_quantity,2); ?></td>
										                <td><?php echo number_format($row2->base_price,2); ?></td>
									        ...
									        <tfoot>
					                            ...
					                            <tr>
					                                <th colspan="6" class="text-right font-weight-bold">Total Qty:</th>
					                                <th class=" font-weight-bold"><?php echo number_format($row->total_quantity,2); ?></th>
					                            </tr>
					                            <tr>
					                                <th colspan="6" class="text-right font-weight-bold lead">Grand Total:</th>
									...
									<div class="card-footer text-center">
										<span class="text-muted">Goods Receipt Note created on <?php echo date('d M, Y H:i:s', strtotime($row->created_on)); ?> by <?php echo $row->first_name . ' ' . $row->last_name; ?></span>
									</div>
								</div>
							</div>
				...
				<div class="modal fade in" id="modal_send_goods_receipt_note_via_email">
				    <div class="modal-dialog modal-lg">
				        <div class="modal-content">
				            <div class="modal-header header-custom">
				                <h4 class="modal-title text-center"><em class="icon ni ni-mail mr-1"></em>Send Goods Receipt Note via Email</h4>
				                <button type="button" class="close" data-dismiss="modal">&times;</button>
				            </div>
				            <form id="frm_send_goods_receipt_note_via_email" name="frm_send_goods_receipt_note_via_email" method="post" class="is-alter" onsubmit="return submit_send_goods_receipt_note_via_email();">
				                <div class="modal-body">
				                    <div class="spinner2 display-none" id="send_goods_receipt_note_via_email_loader">
				                        <div class="rect1"></div>
				                        <div class="rect2"></div>
				                        <div class="rect3"></div>
				                    </div>
				                    <div class="row">
				                        <div class="col-md-12">
				                            <div>
				                                ...
				                                <input type="hidden" id="send_email_goods_receipt_note_id" name="goods_receipt_note_id">
				                ...
				                <div class="modal-footer">
				                    <button type="submit" id="btn_send_goods_receipt_note_via_email" class="btn btn-success"><em class="icon ni ni-send mr-1"></em>Send Email</button>
				...
				<div class="modal fade" tabindex="-1" id="modal_void_goods_receipt_note">
				    <div class="modal-dialog" role="document">
				        <div class="modal-content">
				            <div class="modal-header">
				                <h4 class="modal-title font-weight-bold"><i class="icon ni ni-trash-alt"></i> Void Goods Receipt Note [<span id="void_goods_receipt_note_number"></span>]</h4>
				                <button type="button" class="close" data-dismiss="modal">&times;</button>
				            </div>
				            <div class="modal-body">
				                <div class="spinner display-none" id="void_goods_receipt_note_loader">
				                    <div class="rect1"></div>
				                    <div class="rect2"></div>
				                    <div class="rect3"></div>
				                </div>
				                <form id="frm_void_goods_receipt_note" name="frm_void_goods_receipt_note" method="post" class="is-alter" onsubmit="return submit_void_goods_receipt_note();">

				                    <input type="hidden" id="void_goods_receipt_note_id" name="goods_receipt_note_id">
				                            ...
				                            <div class="">
				                                <div class="">
				                                    <div class="row mt-1">
				                                        <div class="col-md-12">
				                                            <div class="form-group">
				                                                <textarea name="void_reason" cols="40" rows="5" id="goods_receipt_note_void_reason" class="form-control" placeholder="Void Reason"></textarea>
				                                            </div>
				                                        </div>
				                                        <div class="clearfix"></div>
				                                    </div>
				                    ...
				                    <div class="form-group text-right">
				                        <button type="submit" id="btn_void_goods_receipt_note" class="btn btn-primary"><i class="icon-checkmark4 mr-1"></i>Submit</button>
