		...
		<div class="content-wrapper">
				...
				<?php foreach ($stock_writeoff as $row): ?>
						...
						<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
							<div class="d-flex">
								<div class="breadcrumb">
									...
									<span class="breadcrumb-item active">View Stock Write-off (<?php echo $row->stock_writeoff_number; ?>)</span>
								</div>
					...
					<div class="content pt-0">
						<div class="row mb-4">
							<div class="col-md-6">
								<h4 class="text-primary font-weight-bold"><i class="icon-eye"></i> View Stock Write-off (<?php echo $row->stock_writeoff_number; ?>)</h4>
							</div>
							<div class="col-md-6 text-right">
								<a href="<?php echo base_url(); ?>be/inventory/stock_writeoffs" class="btn btn-primary btn-sm"><i class="icon-arrow-left15"></i><span>Stock Write-offs List</span></a>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-md-8">
								<div class="invoice card card-preview p-3">
									<div class="spinner2 display-none" id="stock_writeoffs_loader">
				                        <div class="rect1"></div>
				                        <div class="rect2"></div>
				                        <div class="rect3"></div>
				                    </div>
						                    	...
						                    	<div class="dropdown-menu dropdown-menu-right">
													...
													<?php if ($row->is_void == 0): ?>
														<?php if ($sbr_stock_writeoffs_delete == true): ?>
															<a href="javascript:;" class="dropdown-item void-stock-writeoff" data-stock-writeoff-id="<?php echo $row->stock_writeoff_id; ?>" data-context="View Stock Write-off"><i class="icon-trash-alt"></i> Void Stock Write-off</a>
														<?php endif; ?>
													<?php endif; ?>
						                    	</div>
						                    </div>
											...
											<div class="col-sm-6">
												<div class="mb-4">
													<div class="text-sm-right">
														<h2 class="text-uppercase font-weight-light mb-0">Stock Write-off</h2>
								            			<p class="lead text-info"><?php echo $row->stock_writeoff_number; ?></p>

								            			<p class="mb-3">
										                	<b>Write-off Date:</b> <?php echo date('d M, Y', strtotime($row->writeoff_date)); ?><br />
								            				<b>Outlet:</b> <?php echo $row->outlet_name; ?><br />															
															<b>Written Off By:</b> <?php echo $row->first_name . ' ' . $row->last_name; ?><br />
															<b>Status:</b> 
									    ...
									    <table class="table table-striped table-bordered">
									        <thead>
									            <tr>
									                ...
									                <th style="width: 100px">Written Off Quantity</th>
									            </tr>
									        </thead>
									        <tbody>
									        	<?php foreach ($stock_writeoff_details as $row2): ?>
										            <tr>
										                ...
										                <td><?php echo number_format($row2->writeoff_quantity,2); ?></td>
										            </tr>
										        <?php endforeach; ?>
									        </tbody>
									    </table>
				...
				<div class="modal fade in" id="modal_send_stock_writeoff_via_email">
				    <div class="modal-dialog modal-lg">
				        <div class="modal-content">
				            <div class="modal-header header-custom">
				                <h4 class="modal-title text-center"><em class="icon ni ni-mail mr-1"></em>Send Stock Write-off via Email</h4>
				                <button type="button" class="close" data-dismiss="modal">&times;</button>
				            </div>
				            <form id="frm_send_stock_writeoff_via_email" name="frm_send_stock_writeoff_via_email" method="post" class="is-alter" onsubmit="return submit_send_stock_writeoff_via_email();">
				                <div class="modal-body">
				                    <div class="spinner2 display-none" id="send_stock_writeoff_via_email_loader">
				                        <div class="rect1"></div>
				                        <div class="rect2"></div>
				                        <div class="rect3"></div>
				                    </div>
				                    <div class="row">
				                        <div class="col-md-12">
				                            <div>
				                                ...
				                                <input type="hidden" id="send_email_stock_writeoff_id" name="stock_writeoff_id">
				                ...
				                <div class="modal-footer">
				                    <button type="submit" id="btn_send_stock_writeoff_via_email" class="btn btn-success"><em class="icon ni ni-send mr-1"></em>Send Email</button>
				...
				<div class="modal fade" tabindex="-1" id="modal_void_stock_writeoff">
				    <div class="modal-dialog" role="document">
				        <div class="modal-content">
				            <div class="modal-header">
				                <h4 class="modal-title font-weight-bold"><i class="icon ni ni-trash-alt"></i> Void Stock Write-off [<span id="void_stock_writeoff_number"></span>]</h4>
				                <button type="button" class="close" data-dismiss="modal">&times;</button>
				            </div>
				            <div class="modal-body">
				                <div class="spinner display-none" id="void_stock_writeoff_loader">
				                    <div class="rect1"></div>
				                    <div class="rect2"></div>
				                    <div class="rect3"></div>
				                </div>
				                <form id="frm_void_stock_writeoff" name="frm_void_stock_writeoff" method="post" class="is-alter" onsubmit="return submit_void_stock_writeoff();">

				                    <input type="hidden" id="void_stock_writeoff_id" name="stock_writeoff_id">
				                            ...
				                            <div class="">
				                                <div class="">
				                                    <div class="row mt-1">
				                                        <div class="col-md-12">
				                                            <div class="form-group">
				                                                <textarea name="void_reason" cols="40" rows="5" id="stock_writeoff_void_reason" class="form-control" placeholder="Void Reason"></textarea>
				                                            </div>
				                                        </div>
				                                        <div class="clearfix"></div>
				                                    </div>
				                    ...
				                    <div class="form-group text-right">
				                        <button type="submit" id="btn_void_stock_writeoff" class="btn btn-primary"><i class="icon-checkmark4 mr-1"></i>Submit</button>
