                    ...
                    <table class="table" style="margin-bottom: 0px;">
                        <tr>
                            ...
                            <td width="50%" class="text-right" style="border: 0px">
                                <h3 class="text-uppercase text-normal mb-0">Stock Adjustment<br><small class="text-primary"><?php echo $row->stock_adjustment_number; ?></small></h3>
                    ...
                    <table class="table table-condensed table-bordered table-striped" style="margin-bottom: 0px;">
                        <thead>
                            <tr>
                                ...
                                <th width="20%">Current Qy</th>
                                <th width="20%">Adjusted Qty</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $count = 1; ?>
