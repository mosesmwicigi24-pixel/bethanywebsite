                ...
                <table class="table" style="margin-bottom: 0px;">
                    <tr>
                        ...
                        <td width="50%" class="text-right" style="border: 0px">
                            <h3 class="text-uppercase text-normal mb-0">Stock Write-offs<br><small class="text-primary"><?php //echo $row->pos_sale_number; ?></small></h3>
            ...
            <tbody> 
                ...
                <?php foreach ($stock_writeoffs as $row): ?>
                    <tr class="<?php if ($row->is_void == 1){ echo 'text-muted'; } ?>">    
                        ...
                        <td><?php echo $row->stock_writeoff_number; ?></td>
                        <td><?php echo date('d M, Y', strtotime($row->writeoff_date)); ?></td>
