					...
					<div class="col-md-12">
						<div class="card rounded-top-0">
							...
							<div class="card-header bg-transparent header-elements-inline p-2">
								<h5 class="card-title font-weight-bold"><i class="icon-list3 mr-1"></i> Stock Adjustments</h5>			
								<div class="header-elements">
									<?php if ($sbr_stock_adjustments_add == true): ?>
										<a href="<?php echo base_url(); ?>be/inventory/adjust" class="btn btn-sm btn-primary"><i class="icon-plus-circle2"></i> Adjust Stock</a>
									<?php endif; ?>
								</div>			
							</div>
							...
							<div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<form method="post" class="form" id="frm_filter_stock_adjustments" name="frm_filter_stock_adjustments" method="post">
											<div class="">
												<div class="row">
													...
													<div class="col-sm-2">
														<button id="btn_stock_adjustments_filter" type="button" onclick="filter_stock_adjustments();" class="btn btn-primary btn-sm font-weight-600"><i class="icon-checkmark4"></i> FILTER</button>
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-md-12 text-right">
													<button id="btn_export_stock_adjustments" type="button" onclick="export_stock_adjustments();" class="btn btn-primary btn-sm font-weight-600"><i class="icon-file-pdf"></i> Export</button>
												</div>
											</div>
											<div id="stock_adjustments_div" style="min-height: 400px;">
