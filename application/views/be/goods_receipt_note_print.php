                    ...
                    <table class="table" style="margin-bottom: 0px;">
                        <tr>
                            ...
                            <td width="50%" class="text-right" style="border: 0px">
                                <h3 class="text-uppercase text-normal mb-0">Goods Receipt Note<br><small class="text-primary"><?php echo $row->goods_receipt_note_number; ?></small></h3>
                    ...
                    <table class="table table-condensed table-bordered table-striped" style="margin-bottom: 0px;">
                        <thead>
                            <tr>
                                ...
                                <th width="13%">Unit Cost (<?php echo $default_currency; ?>)</th>
                                <th width="10%">Base Qty</th>
                                <th width="13%">Base Unit Cost (<?php echo $default_currency; ?>)</th>
                                <th width="13%">Total Cost (<?php echo $default_currency; ?>)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $count = 1; ?>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th colspan="2"><?php echo number_format($row->total_quantity,2); ?></th>
                            </tr>
                            <tr>
                                <th colspan="6" class="text-right"><big>Grand Total:</big></th>
                                <th colspan="2"><big><?php echo number_format($row->total_amount,2); ?></big></th>
                            </tr>
                        </tfoot>
                    </table>
                </div>
