...
<head>
	...
	<title>Recover - Bethany House Back End</title>
	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content d-flex justify-content-center align-items-center">
				...
				<form id="frm_recover_password" name="frm_recover_password" method="post" class="login-form" onsubmit="return validate_recover_password();">
					<div class="card mb-0">
						<div class="card-body">
							<div class="text-center mb-3">
								<i class="icon-lifebuoy text-slate-300 border-slate-300 border-3 rounded-round p-3 mb-3 mt-1"></i>
								<h5 class="mb-0">Recover Password</h5>
								<span class="d-block text-muted">Enter your Email Address below to reset your password.</span>
							</div>

							<div id="div_recover_password_error" class="alert alert-danger display-none font-13"></div>
                   			<div id="div_recover_password_success" class="alert alert-success display-none font-13"></div>

							<div class="form-group form-group-feedback form-group-feedback-left">
								<input type="email" class="form-control" placeholder="Email Address" id="recover_password_email_address" name="recover_password_email_address">
							...
							<div class="form-group">
								<button id="btn_recover_password" type="submit" class="btn btn-sm btn-primary btn-block">Submit <i class="icon-circle-right2 ml-2"></i></button>
							</div>

							<div class="text-center">
								<a href="<?php echo base_url();?>be/"><i class="icon-circle-left2"></i> Go Back to Login</a>
							</div>
						</div>
					</div>
				</form>
