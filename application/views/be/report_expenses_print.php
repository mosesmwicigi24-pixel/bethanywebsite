                ...
                <table class="table" style="margin-bottom: 0px;">
                    <tr>
                        ...
                        <td width="50%" class="text-right" style="border: 0px">
                            <h3 class="text-uppercase text-normal mb-0">Expenses Report<br><small class="text-primary"><?php //echo $row->pos_sale_number; ?></small></h3>
        ...
        <table class="table table-condensed" data-auto-responsive="true">
            ...
            <tbody> 
                ...
                <?php foreach ($expenses_report as $row): ?>
                    ...
                    <?php $count++; ?>
                    <?php 
                        $total_expenses = $total_expenses + $row->expense_amount;
                    ?>
                <?php endforeach; ?>
            </tbody>
            <tfoot>
                <tr>
                    ...
                    <th class="font-weight-bold" colspan="5"><?php echo number_format($total_expenses,2); ?></th>                                          
                </tr>
            </tfoot>
        </table>        
