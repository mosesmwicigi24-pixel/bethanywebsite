		...
		<div class="content-wrapper">
				...
				<?php foreach ($stock_transfer as $row): ?>
						...
						<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
							<div class="d-flex">
								<div class="breadcrumb">
									...
									<span class="breadcrumb-item active">View Stock Transfer (<?php echo $row->stock_transfer_number; ?>)</span>
								</div>
					...
					<div class="content pt-0">
						<div class="row mb-4">
							<div class="col-md-6">
								<h4 class="text-primary font-weight-bold"><i class="icon-eye"></i> View Stock Transfer (<?php echo $row->stock_transfer_number; ?>)</h4>
							</div>
							<div class="col-md-6 text-right">
								<a href="<?php echo base_url(); ?>be/inventory/stock_transfers" class="btn btn-primary btn-sm"><i class="icon-arrow-left15"></i><span>Stock Transfers List</span></a>
							</div>
						</div>
						<div class="row">
						                    	...
						                    	<div class="dropdown-menu dropdown-menu-right">
													...
													<?php if ($row->is_void == 0): ?>
														<?php if ($sbr_stock_transfers_delete == true): ?>
															<a href="javascript:;" class="dropdown-item void-stock-transfer" data-stock-transfer-id="<?php echo $row->stock_transfer_id; ?>" data-context="View Stock Transfer"><i class="icon-trash-alt"></i> Void Stock Transfer</a>
														<?php endif; ?>
													<?php endif; ?>
						                    	</div>
						                    </div>
											...
											<div class="col-sm-6">
												<div class="mb-4">
													<div class="text-sm-right">
														<h2 class="text-uppercase font-weight-light mb-0">Stock Transfer</h2>
								            			<p class="lead text-info"><?php echo $row->stock_transfer_number; ?></p>
								            			...
								            			<p class="mb-3">
															...
															<b>Transferred By:</b> <?php echo $row->first_name . ' ' . $row->last_name; ?><br />
															<b>Status:</b> 
