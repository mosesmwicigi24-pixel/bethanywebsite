                ...
                <table class="table" style="margin-bottom: 0px;">
                    <tr>
                        ...
                        <td width="50%" class="text-right" style="border: 0px">
                            <h3 class="text-uppercase text-normal mb-0">Goods Return Notes<br><small class="text-primary"><?php //echo $row->pos_sale_number; ?></small></h3>
            ...
            <tbody> 
                ...
                <?php foreach ($goods_return_notes as $row): ?>
                    <tr class="<?php if ($row->is_void == 1){ echo 'text-muted'; } ?>">    
                        ...
                        <td><?php echo $row->goods_return_note_number; ?></td>
