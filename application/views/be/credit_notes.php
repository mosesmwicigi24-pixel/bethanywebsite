		...
		<div class="content-wrapper">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card rounded-top-0">
							<div class="spinner2 display-none" id="credit_notes_loader">
		                        <div class="rect1"></div>
		                        <div class="rect2"></div>
		                        <div class="rect3"></div>
		                    </div>
							<div class="card-header bg-transparent header-elements-inline p-2">
								<h5 class="card-title font-weight-bold"><i class="icon-list3 mr-1"></i> Credit Notes</h5>			
								<div class="header-elements">
									<?php if ($sbr_credit_note_add == true): ?>
										<a href="<?php echo base_url(); ?>be/inventory/credit_note_add" class="btn btn-sm btn-primary"><i class="icon-plus-circle2"></i> New Credit Note</a>
									<?php endif; ?>
								</div>			
							</div>

							<div id="credit_notes_div" style="min-height: 400px;">
			...
			<div class="modal fade in" id="modal_send_credit_note_via_email">
			    <div class="modal-dialog modal-lg">
			        <div class="modal-content">
			            <div class="modal-header header-custom">
			                <h4 class="modal-title text-center"><em class="icon ni ni-mail mr-1"></em>Send Credit Note via Email</h4>
			                <button type="button" class="close" data-dismiss="modal">&times;</button>
			            </div>
			            <form id="frm_send_credit_note_via_email" name="frm_send_credit_note_via_email" method="post" class="is-alter" onsubmit="return submit_send_credit_note_via_email();">
			                <div class="modal-body">
			                    <div class="spinner2 display-none" id="send_credit_note_via_email_loader">
			                        <div class="rect1"></div>
			                        <div class="rect2"></div>
			                        <div class="rect3"></div>
			                    </div>
			                    <div class="row">
			                        <div class="col-md-12">
			                            <div>
			                                ...
			                                <input type="hidden" id="send_email_credit_note_id" name="credit_note_id">
			                ...
			                <div class="modal-footer">
			                    <button type="submit" id="btn_send_credit_note_via_email" class="btn btn-success"><em class="icon ni ni-send mr-1"></em>Send Email</button>
			...
			<div class="modal fade" tabindex="-1" id="modal_void_credit_note">
			    <div class="modal-dialog" role="document">
			        <div class="modal-content">
			            <div class="modal-header">
			                <h4 class="modal-title"><i class="icon ni ni-trash-alt"></i> Void Credit Note [<span id="void_credit_note_number"></span>]</h4>
			                <button type="button" class="close" data-dismiss="modal">&times;</button>
			            </div>
			            <div class="modal-body">
			                <div class="spinner display-none" id="void_credit_note_loader">
			                    <div class="rect1"></div>
			                    <div class="rect2"></div>
			                    <div class="rect3"></div>
			                </div>
			                <form id="frm_void_credit_note" name="frm_void_credit_note" method="post" class="is-alter" onsubmit="return submit_void_credit_note();">

			                    <input type="hidden" id="void_credit_note_id" name="credit_note_id">
			                            ...
			                            <div class="">
			                                <div class="">
			                                    <div class="row mt-1">
			                                        <div class="col-md-12">
			                                            <div class="form-group">
			                                                <textarea name="void_reason" cols="40" rows="5" id="credit_note_void_reason" class="form-control" placeholder="Void Reason"></textarea>
			                                            </div>
			                                        </div>
			                                        <div class="clearfix"></div>
			                                    </div>
			                    ...
			                    <div class="form-group text-right">
			                        <button type="submit" id="btn_void_credit_note" class="btn btn-success"><i class="icon-checkmark4 mr-1"></i>Submit</button>
