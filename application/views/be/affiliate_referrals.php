		<?php foreach ($affiliate as $row): ?>
			...
			<div class="content-wrapper">
								...
								<div class="card">
									...
									<div class="card-body p-0">
										<ul class="nav nav-sidebar" data-nav-type="accordion">
											...
											<li class="nav-item">
												<a href="<?php echo base_url();?>be/affiliates/account_referrals/<?php echo $row->affiliate_id; ?>" class="nav-link active"><i class="icon-cart"></i> Referrals</a>
											</li>
											<li class="nav-item">
						...
						<div class="w-100">
							<div class="row">
								<div class="col-md-12">
									<div class="card">
										<div class="card-header bg-transparent header-elements-inline p-2">
											<h5 class="card-title font-weight-bold"><i class="icon-cart mr-2"></i> Referrals (<?php echo $row->first_name . ' ' . $row->last_name; ?>)</h5>
										</div>
										<div class="card-body">
											...
											<div class="row">
												<div class="col-md-12">
													<form method="post" class="form">
														<div id="affiliate_referalls_div" style="min-height: 400px;">
				...
				<script type="text/javascript">
					load_affiliate_referrals(<?php echo $row->affiliate_id; ?>);
				</script>
			<?php endforeach; ?>
