...
*/
	...
	*/
	...
	$config['defaults']['tax']['rate'] = 16; // 20%
	 ...
	 */
	$config['defaults']['shipping']['location'] = array('Kenya (KE)');
	$config['defaults']['tax']['location'] = array('Kenya (Kenya)');
	 ...
	 */ 
	$config['defaults']['currency']['name'] = 'Kenyan Shilling';
	$config['defaults']['currency']['symbol'] = 'KES&nbsp;';
