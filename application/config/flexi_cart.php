...
*/
	...
	*/
	 ...
	 */
	$config['defaults']['shipping']['location'] = array('Kenya');
	$config['defaults']['tax']['location'] = array('Kenya');
	 ...
	 */ 
	$config['defaults']['currency']['name'] = 'KES';
	...
	// Default database lookup column, if set, this returned data is used instead of any hard-coded default settings in this file. 
	// To disable, set ['default'] = FALSE.
	$config['database']['tax']['default'] = FALSE;
