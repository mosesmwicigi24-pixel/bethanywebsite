"use strict";
!(function (r, u) {
    (r.Package.name = "DashLite"), (r.Package.version = "1.7.0");
    var c = u(window),
        l = u("body"),
        d = u(document),
        t = "nk-menu",
    ...
    (r.ClassBody = function () {
        ...
        (r.TGL.ddmenu = function (t, e) {
            var n = t || ".nk-menu-toggle",
                ...
                a = e ? h(i, e) : i;
            u(n).on("click", function (t) {
                (r.Win.width < p.lg || u(this).parents().hasClass(g)) && r.Toggle.dropMenu(u(this), a), t.preventDefault();
            });
        }),
        (r.TGL.showmenu = function (t, e) {
            var n = u(t || ".nk-nav-toggle"),
                i = u("[data-content]"),
                a = i.hasClass(f) ? p.lg : p.xl,
        ...
        (r.sbCompact = function () {
            ...
            t.on("click", function (t) {
                ...
                var e = u(this),
                    n = e.data("target"),
                    i = u("[data-content=" + n + "]");
                e.toggleClass("compact-active"), i.toggleClass("is-compact");
            });
        }),
        ...
        (r.Picker.init = function () {
            r.Picker.date(".date-picker"), r.Picker.dob(".date-picker-alt"), r.Picker.time(".time-picker"), r.Picker.date(".date-picker-range", { todayHighlight: !1, autoclose: 1, format: "yyyy-mm-dd" });
        }),
        ...
        (r.init = function () {
            r.coms.docReady.push(r.OtherInit),
                ...
                r.coms.docReady.push(r.sbCompact);
        }),
        r.init();
})(NioApp, jQuery);
