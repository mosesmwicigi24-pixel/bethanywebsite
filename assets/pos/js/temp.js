    ...
    (u.ClassBody = function () {
        ...
        (u.TGL.showmenu = function (t, e) {
            var n = p(t || ".nk-nav-toggle"),
                ...
                t = { active: "toggle-active", content: r + "-active", body: "nav-shown", overlay: "nk-sidebar-overlay", break: i, close: { profile: !0, menu: !1 } },
                o = e ? f(t, e) : t;
            n.on("click", function (t) {
        ...
        (u.Range = function (t, d) {
            p(t).exists() &&
                ...
                p(t).each(function () {
                    ...
                    console.log(t);
                    (e = document.getElementById(e)), (t = { start: n, connect: a, direction: u.State.isRTL ? "rtl" : "ltr", range: { min: i, max: o }, margin: s, limit: r, step: c, orientation: l, tooltips: t }), (t = d ? f(t, d) : t);
