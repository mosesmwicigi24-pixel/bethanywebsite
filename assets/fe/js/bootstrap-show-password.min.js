  ...
  var Constants = {
    html: {
      inputGroups: {
        ...
        4: ['<div class="%s"><button tabindex="100" title="%s" class="btn btn-outline-default" type="button">', '</button></div>']
      }[bootstrapVersion]
    } // TOOLS DEFINITION
    // ======================
    ...
    _createClass(Password, [{
      ...
      value: function show(_relatedTarget) {
        ...
        if (this.options.eyeClassPositionInside) {
          this.$icon.find('i,svg').removeClass('icon-eye').addClass('icon-eye-crossed fa-lg ').html(this.options.eyeCloseClass);
        } else {
          this.$icon.find('i,svg').removeClass("icon-eye ".concat(this.options.eyeOpenClass)).addClass("icon-eye-crossed fa-lg ".concat(this.options.eyeCloseClass));
        }
      ...
      value: function hide(_relatedTarget) {
        ...
        if (this.options.eyeClassPositionInside) {
          this.$icon.find('i,svg').removeClass('icon-eye-crossed').addClass('icon-eye fa-lg ').html(this.options.eyeOpenClass);
        } else {
          this.$icon.find('i,svg').removeClass("icon-eye-crossed ".concat(this.options.eyeCloseClass)).addClass("icon-eye fa-lg ".concat(this.options.eyeOpenClass));
        }
