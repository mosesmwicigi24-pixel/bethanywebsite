    ...
    var _componentUiAutocomplete = function() {
        ...
        $('#ac-caching').autocomplete({
            ...
            source: function(request, response) {
                ...
                $.getJSON('../../../../../../../../../external.html?link=http://demo.interface.club/limitless/demo/bs4/Template/global_assets/demo_data/jquery_ui/autocomplete.php', request, function(data, status, xhr) {
                    cache[ term ] = data;
                    response(data);
                });
            },
