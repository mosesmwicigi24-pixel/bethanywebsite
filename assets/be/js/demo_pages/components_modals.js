...
var Modals = function () {
    ...
    var _componentModalRemote = function() {
        $('#modal_remote').on('show.bs.modal', function() {
            $(this).find('.modal-body').load('../../../../../../../../../external.html?link=http://demo.interface.club/limitless/demo/bs4/Template/global_assets/demo_data/wizard/education.html', function() {
                _componentSelect2();
            });
        });
    };
